                ...
                <ul class="menu">
                    ...
                    <li class="main-header-navigation-list-single single-4">
                        ...
                        <li class="main-header-navigation-list-single single-5">
                            <a class="main-header-navigation-link link-4 sub" href="signUp">Регистрация</a>
                        </li>
                </ul>
            </nav>
            <div class="basket">
...
<main class="main">
    <div class="signIn-form singInF">
        <form method="post">
            ...
            <div>
                <input class="btn signIn-btn" type="submit" value="Войти">
            </div>
        </form>
    </div>
</main>
